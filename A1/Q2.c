/* Program to print parantheses representation of a BST
 * Author   -   Anish Sharma
 * Date     -   19/01/2020
*/
...
void main() {
    ...
    while (1) {
        ...
        if (!strcmp(cmd, "insr")) {
            ...
            printf("%d\n", num);
        } else if (!strcmp(cmd, "pred")) {
            scanf("%d", &num);
            Node* pred = predecessor(root, search(root, num));
            if (pred == (Node*) -1) {
                printf("-1\n");
                continue;
            }
        ...
        } else if (!strcmp(cmd, "succ")) {
            scanf("%d", &num);
            Node* succ = successor(root, search(root, num));
            if (succ == (Node*) -1) {
                printf("-1\n");
                continue;
            }
        ...
        } else if (!strcmp(cmd, "delt")) {
            scanf("%d", &num);
            delete(&root, num);
        } else if (!strcmp(cmd, "inor")) {
            inorder(root);
            printf("\n");
        } else if (!strcmp(cmd, "prer")) {
            preorder(root);
            printf("\n");
